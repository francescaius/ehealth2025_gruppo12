...
public class ATTO2LAVORATORE : MonoBehaviour
{
    ...
    IEnumerator Part1()
    {
        ...
        yield return Mattia.ChangePose("ridendo");
        yield return VisualNovelManager.S.dialog.DisplayText ("Mattia", "You kept thinking about that job offer?");
        ...
        yield return VisualNovelManager.S.dialog.DisplayText ("Luca","Effort shows you’re growing, right? The late nights, the competition, the courses… everything leads somewhere. In the end… I can say I made it. I did everything I had to.");
        ...
        yield return Mattia.ChangePose("parlando");
        yield return VisualNovelManager.S.dialog.DisplayText ("Mattia", "Anyway, I was looking for you. They were talking about the closure of that library we used to go to as kids… and about some guy who drew on the wall right before they shut it down. Tons of graffti. Strange, huh?");
        yield return Luca.ChangePose ("incuriosito");
        ...
        yield return VisualNovelManager.S.dialog.DisplayText ("Luca","I don’t know why… it reminds me of my brother. Could be a coincidence. Just a random graffiti.");
    ...
    private IEnumerator Restareneldubbio()
    {
        ...
        yield return VisualNovelManager.S.dialog.DisplayText ("Mattia","That graffiti is real. It’s there, not on a screen.");
