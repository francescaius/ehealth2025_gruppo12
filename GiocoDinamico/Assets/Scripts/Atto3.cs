...
// public class Atto3 : MonoBehaviour
// {
//     // Start is called once before the first execution of Update after the MonoBehaviour is created

//     [SerializeField] ControllerElementoDiScena background;
//     [SerializeField] ControllerElementoDiScena Anonimo; //potrebbe essere luca, marta, etc... chiamare questa variabile
//     [SerializeField] ControllerElementoDiScena Margherita; //ipotizziamo 2 marionette
...
//         //yield return background.ChangePose("telefono");
...
//         yield return VisualNovelManager.S.dialog.DisplayText(
//            "Anonimo",
//            "There’s no need to look for me. I’m watching you from here."
//         );
//         //yield return background.ChangePose("telefono");
//         yield return VisualNovelManager.S.dialog.DisplayText(
//            "Luca",
